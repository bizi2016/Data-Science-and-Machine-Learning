...
"""
# 初始化XGBoost分类器，增加参数'tree_method'和'predictor'以启用GPU加速
xgb_model = xgb.XGBClassifier(
    objective='binary:logistic',
    eval_metric='logloss',
    scale_pos_weight=scale_pos_weight,
...
# 保存最佳模型到文件
joblib.dump(best_model, 'best_model_GPU.pkl')

# 加载最佳模型
# loaded_model = joblib.load('best_model_GPU.pkl')
...
最优参数
====================
{'colsample_bytree': 0.7, 'learning_rate': 0.1, 'max_depth': 5, 'min_child_weight': 1, 'n_estimators': 300, 'subsample': 0.9}

最优AUC
====================
0.9302797371991268

mean_acc = 0.8364930634763781
mean_f1 = 0.7159663813946452
mean_auc = 0.9302797371991268
"""
